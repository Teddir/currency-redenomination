...
export default function Features() {
  ...
  return (
    <section id="features" className="relative py-16 sm:py-20 md:py-24 lg:py-28 scroll-mt-20">
      ...
      >
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent via-blue-50/30 dark:via-blue-950/20 to-transparent"></div>
      </motion.div>
          ...
          >
            {features.map((feature, idx) => (
              <motion.div
                ...
                className="group relative bg-white dark:bg-slate-800/50 backdrop-blur-sm p-5 sm:p-6 md:p-7 rounded-xl sm:rounded-2xl border border-slate-200/50 dark:border-slate-700/50 hover:border-blue-400/60 dark:hover:border-blue-600/60 transition-all duration-300"
                whileHover={{
                  y: -8,
                  scale: 1.02,
              ...
              >
                ...
                <motion.div
                  className="absolute inset-0 bg-gradient-to-br from-blue-500/0 via-purple-500/0 to-pink-500/0 rounded-xl sm:rounded-2xl pointer-events-none"
                  whileHover={{
                    background: [
                ...
                <div className="relative">
                  ...
                  {/* Title */}
                  <h3 className="text-base sm:text-lg md:text-xl font-bold mb-2 sm:mb-3 text-slate-900 dark:text-slate-100 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                    {feature.title}
                  </h3>
